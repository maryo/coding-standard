...
$array = array_merge(
	[],
	array_map(
		function (): string {return 'very looooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooong value';},
		[]
	)
);
...
doSomething('anything') ? true : doSomethingElse(
	'very looooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooong parameter'
);

in_array(
	strtolower('striiiiiiiiiiiiiiiiiiiiiing'),
